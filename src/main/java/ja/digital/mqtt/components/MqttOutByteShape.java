 ...
 */
public class MqttOutByteShape implements Shape {
     ...
     */
    public MqttOutByteShape(ElementAttributes elementAttributes, PinDescriptions inputs, PinDescriptions outputs) {
        this.inputs = inputs;
        this.outputs = outputs;
        ellipseSize = elementAttributes.get(MqttOutByte.ELLIPSE_SIZE);
    }
