 ...
 */
public class MqttInByteShape implements Shape {
     ...
     */
    public MqttInByteShape(ElementAttributes elementAttributes, PinDescriptions inputs, PinDescriptions outputs) {
        this.inputs = inputs;
        this.outputs = outputs;
        ellipseSize = elementAttributes.get(MqttInByte.ELLIPSE_SIZE);
    }
    ...
    public Pins getPins() {
        return new Pins()
                ...
                .add(new Pin(vec(0, SIZE * 4), outputs.get(0)))
                .add(new Pin(vec(0, SIZE * 8), outputs.get(1)))
                ;
    }
    ...
    public void drawTo(Graphic graphic, Style highLight) {
        ...
        // draw the text "Or"
        graphic.drawText(vec(SIZE * 3 / 2, SIZE), vec(1, SIZE), "Cenas", Orientation.CENTERCENTER, Style.NORMAL);
    }
}
